...
public class FancyMessage {
    ...
    public static String BOSS_DEFEATED =
        "`7MM\"\"\"Yp,   .g8\"\"8q.    .M\"\"\"bgd  .M\"\"\"bgd     `7MM\"\"\"Yb. `7MM\"\"\"YMM  `7MM\"\"\"YMM `7MM\"\"\"YMM        db   MMP\"\"MM\"\"YMM `7MM\"\"\"YMM  `7MM\"\"\"Yb.   \n"
            + "  MM    Yb .dP'    `YM. ,MI    \"Y ,MI    \"Y       MM    `Yb. MM    `7    MM    `7   MM    `7       ;MM:  P'   MM   `7   MM    `7    MM    `Yb. \n"
            + "  MM    dP dM'      `MM `MMb.     `MMb.           MM     `Mb MM   d      MM   d     MM   d        ,V^MM.      MM        MM   d      MM     `Mb \n"
            + "  MM\"\"\"bg. MM        MM   `YMMNq.   `YMMNq.       MM      MM MMmmMM      MM\"\"MM     MMmmMM       ,M  `MM      MM        MMmmMM      MM      MM \n"
            + "  MM    `Y MM.      ,MP .     `MM .     `MM       MM     ,MP MM   Y  ,   MM   Y     MM   Y  ,    AbmmmqMA     MM        MM   Y  ,   MM     ,MP \n"
            + "  MM    ,9 `Mb.    ,dP' Mb     dM Mb     dM       MM    ,dP' MM     ,M   MM         MM     ,M   A'     VML    MM        MM     ,M   MM    ,dP' \n"
            + ".JMMmmmd9    `\"bmmd\"'   P\"Ybmmd\"  P\"Ybmmd\"      .JMMmmmdP' .JMMmmmmMMM .JMML.     .JMMmmmmMMM .AMA.   .AMMA..JMML.    .JMMmmmmMMM .JMMmmmdP'";
